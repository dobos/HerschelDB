...
table = asciiTableReader(file= CWD + "list/spire_spectro.txt", tableType="SPACES")
...
tds.addColumn("numPoints", Column(numPT))
...
asciiTableWriter(table=tds, file= CWD + 'obs/spire_spectro.txt', formatter=formatter)
