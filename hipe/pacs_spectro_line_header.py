...
table = asciiTableReader(file= CWD + "list/pacs_spectro_line.txt", tableType="SPACES")
...
asciiTableWriter(table=tds, file= CWD + 'obs/pacs_spectro_line.txt', formatter=formatter)
