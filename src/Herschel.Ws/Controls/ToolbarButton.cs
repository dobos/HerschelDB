...
[assembly: WebResource("Herschel.Ws.Controls.ToolbarButton.js", "text/javascript", PerformSubstitution = true)]
...
namespace Herschel.Ws.Controls
{
    public class ToolbarButton : WebControl, IButtonControl, IPostBackEventHandler, IScriptControl
    {
        ...
        {
            yield return new ScriptReference("Herschel.Ws.ToolbarButton.js", "Herschel.Ws");
        }
